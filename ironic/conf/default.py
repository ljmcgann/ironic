...
driver_opts = [
    ...
    cfg.StrOpt('default_security_interface',
               help=_DEFAULT_IFACE_HELP.format('security')),
    cfg.ListOpt('enabled_security_interfaces',
                default=['no-security'],
                help=_ENABLED_IFACE_HELP.format('security')),
